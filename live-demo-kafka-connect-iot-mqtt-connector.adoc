...
[source,bash]
----
vi /Users/restrada/confluent-5.1.0/etc/kafka/connect-log4j.properties
// => Change log level
...
Configure MQTT Connector properties file (for Kafka Connect standalone mode) `/Users/restrada/confluent-5.0.0/share/confluent-hub-components/confluentinc-kafka-connect-mqtt/etc/source-anonymous.properties` with your values for
